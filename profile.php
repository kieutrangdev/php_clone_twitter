<?php
    ...
    if(isset($_GET['username']) === true && empty($_GET['username']) ===false)
    {
        ...
        $name = $getFromU->checkInput($_GET['username']);
        $profileId = $getFromU->userIdByUserName($name);
                        ...
                        <li class="hover"><label class="drop-label" for="drop-wrap1"><img src="<?php echo BASE_URL.$user->profileImage;?>"/></label>
                            ...
                            <div class="drop-wrap">
                                <div class="drop-inner">
                                    <ul>
                                        <li><a href="<?php echo BASE_URL?>"><?php echo $user->name;?></a></li>
                                        <li><a href="<?php echo BASE_URL ?>">Settings</a></li>
                                        <li><a href="includes/log-out.php">Log out</a></li>
                                    </ul>
                                </div>
                            </div>
                        </li>
                ...
                <ul>
                    ...
                    <li>
                        <a href="PROFILE-LINK/following">
                            <div class="n-head">
                                <a href="<?php echo BASE_URL.$profileData->name;?>/following">FOLLOWING</a>
                            </div>
                            <div class="n-bottom">
                        ...
                        <div class="profile-info-inner">
                            ...
                            <div class="profile-name-wrap">
                                <div class="profile-name">
                                    <a href="<?php echo BASE_URL.$profileData->name;?>"><?php echo $profileData->screenName;?></a>
                                </div>
                                <div class="profile-tname">
                                    @<span class="username"><?php echo $profileData->name;?></span>
                                </div>
                            </div>
